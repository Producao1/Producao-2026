const products = [
  {
    id: 1,
    name: 'Vanta Runner Pro',
    category: 'Performance',
    color: '#1f1f1f',
    price: 429.9,
    description: 'Cushion premium para treino e uso diário.',
    tag: 'Mais vendido',
  },
  {
    id: 2,
    ...
    color: '#b77a36',
    price: 389.9,
    description: 'Visual urbano com conforto para caminhar.',
    tag: 'Novo',
  },
  {
    id: 3,
    ...
    color: '#a6a6a6',
    price: 459.9,
    description: 'Entrega estabilidade e design refinado.',
    tag: 'Premium',
  },
  {
    id: 4,
    ...
    color: '#c55a45',
    price: 349.9,
    description: 'Trata bem os pés em qualquer rotina.',
    tag: 'Popular',
  },
  {
    id: 5,
    ...
    color: '#3e5a7d',
    price: 399.9,
    description: 'Minimalista, leve e incrivelmente confortável.',
    tag: 'Elite',
  },
  {
    id: 6,
    ...
    color: '#2a2a2a',
    price: 469.9,
    description: 'Perfil esportivo com detalhes premium.',
    tag: 'Limitado',
  },
];
